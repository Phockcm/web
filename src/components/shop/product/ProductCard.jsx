...
export default function ProductCard({ product }) {
  ...
  return (
    ...
    >
      ...
      <button className="mt-3.5 w-full py-2 bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white rounded-xl text-xs font-bold transition-colors duration-200 cursor-pointer">
        Thêm vào giỏ
      </button>
    </Link>
  );
